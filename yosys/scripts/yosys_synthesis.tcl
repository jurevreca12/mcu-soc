...
# default from yosys_common.tcl: top_design=mcu-chip; sv_flist=./mcu-soc.flist
...
yosys setattr -set keep_hierarchy 1 "t:mcu_chip$*"
yosys setattr -set keep_hierarchy 1 "t:mcu_soc$*"
yosys setattr -set keep_hierarchy 1 "t:rvj1_obi$*"
yosys setattr -set keep_hierarchy 1 "t:rvj1_top$*"
yosys setattr -set keep_hierarchy 1 "t:obi_xbar$*"
yosys setattr -set keep_hierarchy 1 "t:obi_ram$*"
yosys setattr -set keep_hierarchy 1 "t:dmi_jtag$*"
yosys setattr -set keep_hierarchy 1 "t:dm_obi_top$*"
yosys setattr -set keep_hierarchy 1 "t:dm_top$*"
yosys setattr -set keep_hierarchy 1 "t:dm_sba$*"
yosys setattr -set keep_hierarchy 1 "t:dm_csrs$*"
yosys setattr -set keep_hierarchy 1 "t:dm_mem$*"
yosys setattr -set keep_hierarchy 1 "t:dmi_jtag_tap$*"
yosys setattr -set keep_hierarchy 1 "t:obi_uart$*"
yosys setattr -set keep_hierarchy 1 "t:obi_gpio$*"
yosys setattr -set keep_hierarchy 1 "t:obi_timer$*"
yosys setattr -set keep_hierarchy 1 "t:obi_spi$*"
yosys setattr -set keep_hierarchy 1 "t:obi_rom$*"
yosys setattr -set keep_hierarchy 1 "t:rvj1_ifu$*"
yosys setattr -set keep_hierarchy 1 "t:rvj1_alu$*"
yosys setattr -set keep_hierarchy 1 "t:rvj1_dec$*"
yosys setattr -set keep_hierarchy 1 "t:rvj1_regfile$*"
yosys setattr -set keep_hierarchy 1 "t:rvj1_branch$*"
yosys setattr -set keep_hierarchy 1 "t:rvj1_lsu$*"
yosys setattr -set keep_hierarchy 1 "t:rvj1_ctrl$*"
...
yosys setattr -set keep_hierarchy 1 "t:skidbuffer$*"
yosys setattr -set keep_hierarchy 1 "t:byte_select_read$*"
yosys setattr -set keep_hierarchy 1 "t:bytewrite_sram$*"
yosys setattr -set keep_hierarchy 1 "t:sram_impl$*"
