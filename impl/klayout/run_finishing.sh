...
lef_files="$(find "$PDK_DIR_LEF_TECH" -name 'sg13cmos5l_stdcell.lef' -exec realpath {} \;) \
     $(find "$PDK_DIR_LEF_CELLS" -name 'sg13cmos5l_tech.lef' -exec realpath {} \;) \
...
gen_seal_ring() {
    ...
    run_cmd "klayout -n sg13cmos5l -zz \
